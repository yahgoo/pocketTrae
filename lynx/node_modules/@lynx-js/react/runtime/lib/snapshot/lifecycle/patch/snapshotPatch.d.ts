 ...
 */
export declare const SnapshotOperation: {
    readonly CreateElement: 0;
    readonly InsertBefore: 1;
    readonly RemoveChild: 2;
    readonly SetAttribute: 3;
    readonly SetAttributes: 4;
    readonly nodesRefInsertBefore: 5;
    readonly nodesRefRemoveChild: 6;
    readonly DEV_ONLY_AddSnapshot: 100;
    readonly DEV_ONLY_RegisterWorklet: 101;
    readonly DEV_ONLY_SetSnapshotEntryName: 102;
};
export declare const SnapshotOperationParams: Record<number, {
    name: string;
    params: string[];
}>;
