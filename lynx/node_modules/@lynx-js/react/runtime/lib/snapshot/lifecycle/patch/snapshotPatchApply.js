        ...
        switch (snapshotPatch[i]) {
            ...
            case SnapshotOperation.DEV_ONLY_AddSnapshot: {
                if (__DEV__) {
                    ...
                    snapshotCreatorMap[uniqID] = evaluate(snapshotCreator);
                }
                break;
            }
            case SnapshotOperation.DEV_ONLY_SetSnapshotEntryName: {
                if (__DEV__) {
                    ...
                    snapshotCreatorMap[uniqID] = evaluate(snapshotCreatorMap[uniqID].toString().replace(/globDynamicComponentEntry/g, JSON.stringify(entryName)));
                }
                break;
            }
