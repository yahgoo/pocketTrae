...
import { onWorkletCtxUpdate, retainWorkletCtx, runWorkletCtx, updateWorkletRef as update, } from '@lynx-js/react/worklet-runtime/bindings';
...
export function updateWorkletRef(snapshot, expIndex, oldValue, elementIndex, workletType) {
    const value = snapshot.__values[expIndex];
    if (workletType === 'main-thread' && value && value._wkltId) {
