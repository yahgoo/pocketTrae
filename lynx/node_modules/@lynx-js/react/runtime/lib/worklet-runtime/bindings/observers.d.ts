 ...
 */
export declare function onWorkletCtxUpdate(worklet: Worklet, oldWorklet: Worklet | null | undefined, isFirstScreen: boolean, element: ElementNode): void;
export declare function retainWorkletCtx(worklet: Worklet): void;
/**
 * This must be called when the hydration is finished.
 */
export declare function onHydrationFinished(): void;
