...
import { MagicHeader0, MagicHeader1, TemplateSectionLabel, } from '../constants.js';
...
export function encode(tasmJSON) {
    const { styleInfo, manifest, cardType, appType, pageConfig, lepusCode, customSections, } = tasmJSON;
