...
export type CreateComponentPAPI = (componentParentUniqueID: number, componentID: string, componentCSSID: number, entryName: string, name: string, path: string, config: Record<string, Cloneable> | null | undefined, info: Record<string, Cloneable> | null | undefined) => HTMLElement;
...
export type CreatePagePAPI = (componentID: string, componentCSSID: number, info?: Record<string, Cloneable> | null | undefined) => HTMLElement;
...
export type QuerySelectorPAPI = (element: HTMLElement, selector: string, options?: unknown) => unknown;
export type QuerySelectorAllPAPI = (element: HTMLElement, selector: string, options?: unknown) => unknown[];
...
export interface MainThreadGlobalAPIs {
    ...
    __LoadLepusChunk: (path: string, config?: {
