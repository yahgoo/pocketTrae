...
export class MainThreadWasmContext {
    ...
    create_element_common(parent_component_unique_id, dom, dom_ref, component_css_id, component_id) {
        ...
        const ret = wasm.mainthreadwasmcontext_create_element_common(this.__wbg_ptr, parent_component_unique_id, dom, dom_ref, isLikeNone(component_css_id) ? 0x100000001 : (component_css_id) >> 0, ptr0, len0);
        return ret >>> 0;
    }
    /**
     * @param {Uint32Array} bubble_unique_id_path
