/* @ts-self-types="./server_debug.d.ts" */
...
export class MainThreadServerContext {
     ...
     * @param {number | null} [component_css_id_opt]
     * @param {string | null} [component_id]
     * @returns {number}
     */
    create_element(tag_name, parent_component_unique_id, component_css_id_opt, component_id) {
        ...
        var len1 = WASM_VECTOR_LEN;
        const ret = wasm.mainthreadservercontext_create_element(this.__wbg_ptr, ptr0, len0, isLikeNone(parent_component_unique_id) ? 0x100000001 : (parent_component_unique_id) >>> 0, isLikeNone(component_css_id_opt) ? 0x100000001 : (component_css_id_opt) >> 0, ptr1, len1);
        return ret >>> 0;
    }
    /**
     * @param {number} element_id
     ...
     */
    get_parent(child_id) {
        const ret = wasm.mainthreadservercontext_get_parent(this.__wbg_ptr, child_id);
    ...
    insert_before(parent_id, child_id, ref_id) {
        wasm.mainthreadservercontext_insert_before(this.__wbg_ptr, parent_id, child_id, isLikeNone(ref_id) ? 0x100000001 : (ref_id) >>> 0);
    }
    /**
     ...
     */
    constructor(view_attributes, enable_css_selector, transform_vw, transform_vh, transform_rem) {
        const ptr0 = passStringToWasm0(view_attributes, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.mainthreadservercontext_new(ptr0, len0, enable_css_selector, transform_vw, transform_vh, transform_rem);
    ...
    remove_child(parent_id, child_id) {
        wasm.mainthreadservercontext_remove_child(this.__wbg_ptr, parent_id, child_id);
    }
    /**
     * @param {number} new_child_id
     * @param {number} old_child_id
     */
    replace_element(new_child_id, old_child_id) {
        wasm.mainthreadservercontext_replace_element(this.__wbg_ptr, new_child_id, old_child_id);
    }
    /**
     * @param {number} parent_id
     * @param {Uint32Array} new_children_ids
     * @param {Uint32Array} old_children_ids
     */
    replace_elements(parent_id, new_children_ids, old_children_ids) {
        const ptr0 = passArray32ToWasm0(new_children_ids, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray32ToWasm0(old_children_ids, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.mainthreadservercontext_replace_elements(this.__wbg_ptr, parent_id, ptr0, len0, ptr1, len1);
    }
    /**
     * @param {number} element_id
     * @param {string} key
     ...
     */
    set_inline_styles_in_key_value_vec(element_id, k_v_vec) {
        const ptr0 = passArrayJsValueToWasm0(k_v_vec, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.mainthreadservercontext_set_inline_styles_in_key_value_vec(this.__wbg_ptr, element_id, ptr0, len0);
    }
    /**
     * @param {number} element_id
     * @param {string} styles
 ...
 * @returns {Uint8Array}
 */
export function decode_style_info(buffer, entry_name, config_enable_css_selector, transform_vw, transform_vh, transform_rem) {
    var ptr0 = isLikeNone(entry_name) ? 0 : passStringToWasm0(entry_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function encode_legacy_json_generated_raw_style_info(raw_style_info, config_enable_css_selector, entry_name, transform_vw, transform_vh, transform_rem) {
 ...
 * @param {string} css
 */
export function init_server_in_shadow_css(css) {
    const ptr0 = passStringToWasm0(css, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.init_server_in_shadow_css(ptr0, len0);
}
...
const wasmUrl = new URL('server_debug_bg.wasm', import.meta.url);
