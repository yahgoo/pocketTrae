...
function transformVariables(block) {
    return Object.fromEntries(block.children.toArray().filter((node) => {
...
function transformStyleRule(node, errors) {
...
function transformAtRuleContent(block, errors, options) {
    if (!block)
        return [];
    const rules = [];
