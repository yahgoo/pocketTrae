(() => {
  var __webpack_modules__ = {
    591: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      const { HtmlWebpackChildCompiler } = __nccwpck_require__(860);
    ...
    78: (module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      const { CachedChildCompilation } = __nccwpck_require__(591);
      const { createHtmlTagObject, htmlTagObjectToString, HtmlTagArray } =
        __nccwpck_require__(695);
      const prettyError = __nccwpck_require__(827);
      const chunkSorter = __nccwpck_require__(60);
      const getHtmlRspackPluginHooks =
        __nccwpck_require__(98).getHtmlRspackPluginHooks;
