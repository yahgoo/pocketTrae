        ...
        for (var _i = 0; _i < hooks.length; _i += 1) {
          ...
          if (hook.__H) {
            for (var j = 0; j < hook.__H.length; j++) {
              ...
              if (isNaN(arg)) {
                var componentName = getDisplayName(vnode);
                console.warn("Invalid argument passed to hook. Hooks should not be called with NaN in the dependency array. Hook index " + _i + " in component " + componentName + " was called with NaN.");
              }
            }
          }
        }
...
export { getCurrentVNode, getDisplayName, getOwnerStack, resetPropWarnings };
