(function (global, factory) {
	...
	(global = global || self, factory(global.jsxRuntime = {}, global.preact));
	...
	function createVNode(type, props, key, isStaticChildren, __source, __self) {
	  ...
	  if (typeof type === 'function' && (ref = type.defaultProps)) {
	    for (i in ref) if (normalizedProps[i] === undefined) {
	...
	function jsxTemplate(templates) {
	  var vnode = createVNode(preact.Fragment, {
	    tpl: templates,
	...
	function jsxAttr(name, value) {
	  if (preact.options.attr) {
	    var result = preact.options.attr(name, value);
