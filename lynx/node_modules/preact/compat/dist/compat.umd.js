(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('preact'), require('preact/hooks')) :
	typeof define === 'function' && define.amd ? define(['exports', 'preact', 'preact/hooks'], factory) :
	(global = global || self, factory(global.preactCompat = {}, global.preact, global.preactHooks));
})(this, (function (exports, preact, hooks) {
	/**
	...
	var useInsertionEffect = hooks.useLayoutEffect;
	...
	var PureComponent = /*#__PURE__*/function () {
	  ...
	  _PureComponent.prototype = new preact.Component();
	...
	function memo(c, comparer) {
	  ...
	  function Memoed(props) {
	    ...
	    return preact.createElement(c, props);
	  }
	...
	var oldDiffHook = preact.options.__b;
	...
	var mapFn = function mapFn(children, fn) {
	  ...
	  return preact.toChildArray(preact.toChildArray(children).map(fn));
	};
	...
	var Children = {
	  ...
	  count: function count(children) {
	    return children ? preact.toChildArray(children).length : 0;
	  },
	  only: function only(children) {
	    var normalized = preact.toChildArray(children);
	...
	preact.options.__e = function (error, newVNode, oldVNode, errorInfo) {
	  if (error.then) {
	...
	var oldUnmount = preact.options.unmount;
	preact.options.unmount = function (vnode) {
	  /** @type {import('./internal').Component} */
	...
	var Suspense = /*#__PURE__*/function () {
	  ...
	  _Suspense.prototype = new preact.Component();
	  /**
	  ...
	  _Suspense.prototype.render = function (props, state) {
	    if (this.__b) {
	      ...
	      if (this.__v.__k) {
	        var detachedParent = preact.options.document.createElement('div');
	    ...
	    var fallback = state.__a && preact.createElement(preact.Fragment, null, props.fallback);
	    if (fallback) fallback.__u &= ~MODE_HYDRATE;
	    return [preact.createElement(preact.Fragment, null, state.__a ? null : props.children), fallback];
	  };
	  return _Suspense;
	}();
	...
	function lazy(loader) {
	  ...
	  function Lazy(props) {
	    ...
	    return component ? preact.createElement(component, props) : null;
	  }
	...
	var SuspenseList = /*#__PURE__*/function () {
	  ...
	  // - call `new Component()` as the prototype
	  // - do not set `Suspense.prototype.constructor` to `Suspense`
	  _SuspenseList.prototype = new preact.Component();
	  ...
	  _SuspenseList.prototype.render = function (props) {
	    this._next = null;
	    this._map = new Map();
	    var children = preact.toChildArray(props.children);
	...
	function Portal(props) {
	  ...
	  _this.componentWillUnmount = function () {
	    preact.render(null, _this._temp);
	    _this._temp = null;
	  ...
	  preact.render(preact.createElement(ContextProvider, {
	...
	function createPortal(vnode, container) {
	  var el = preact.createElement(Portal, {
	    __v: vnode,
	...
	preact.Component.prototype.isReactComponent = true;
	...
	['componentWillMount', 'componentWillReceiveProps', 'componentWillUpdate'].forEach(function (key) {
	  Object.defineProperty(preact.Component.prototype, key, {
	    configurable: true,
	    get: function get() {
	...
	function createFactory(type) {
	  return preact.createElement.bind(null, type);
	}
	...
	function isFragment(element) {
	  return isValidElement(element) && element.type === preact.Fragment;
	}
	...
	function cloneElement(element) {
	  ...
	  return preact.cloneElement.apply(null, arguments);
	}
	...
	var flushSync = function flushSync(callback, arg) {
	  var prevDebounce = preact.options.debounceRendering;
	  preact.options.debounceRendering = function (cb) {
	    return cb();
	  };
	  var res = callback(arg);
	  preact.options.debounceRendering = prevDebounce;
	  return res;
	};
	...
	Object.defineProperty(exports, 'Component', {
		enumerable: true,
		get: function () { return preact.Component; }
	});
	...
	Object.defineProperty(exports, 'createRef', {
		enumerable: true,
		get: function () { return preact.createRef; }
	});
